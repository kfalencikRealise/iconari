    ...
    <div class="container">
      <div class="columns">
        <div class="column is-half-widescreen">
          ...
          <p> </p>
          <p>Thank you for choosing to be part of our community at Iconari LLC, doing business as Iconari (“ <strong> Iconari </strong> ”, “ <strong> we </strong> ”, “ <strong> us </strong> ”, or “ <strong> our </strong> ”). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy , or our practices with regards to your personal information, please contact us at kfalencik@gmail.com.</p>
          <p>When you visit our website iconari.com, and use our services, you trust us with your personal information. We take your privacy very seriously. In this privacy policy, we seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy policy that you do not agree with, please discontinue use of our Sites and our services. </p>
          <p>This privacy policy applies to all information collected through our website (such as iconari.com), and/or any related services, sales, marketing or events (we refer to them collectively in this privacy policy as the " <strong> Services </strong> ").  </p>
          ...
          <p><strong> Publicly Available Personal Information. </strong>  We collect first name, maiden name, last name, and nickname; ID; phone numbers; email addresses; and other similar data.</p>
          <p><strong> Personal Information Provided by You. </strong>  We collect data collected from surveys; purchase history; financial information (credit card number, purchase history, invoices); and other similar data.</p>
          ...
          <ul>
            <li><strong> To facilitate account creation and logon process. </strong>  If you choose to link your account with us to a third party account (such as your Google or Facebook account), we use the information you allowed us to collect from those third parties to facilitate account creation and logon process for the performance of the contract. See the section below headed " <a href="#sociallogins"> HOW DO WE HANDLE YOUR SOCIAL LOGINS </a> " for further information. <br /> </li>
            <li><strong> To send you marketing and promotional communications. </strong>  We and/or our third party marketing partners may use the personal information you send to us for our marketing purposes, if this is in accordance with your marketing preferences. You can opt-out of our marketing emails at any time (see the " <a href="#privacyrights"> WHAT ARE YOUR PRIVACY RIGHTS </a> " below). <br /> </li>
            <li><strong> To send administrative information to you.  </strong> We may use your personal information to send you product, service and new feature information and/or information about changes to our terms, conditions, and policies. <br /> </li>
            <li><strong> Fulfill and manage your orders. </strong>  We may use your information to fulfill and manage your orders, payments, returns, and exchanges made through the Services.                <br /> </li>
            ...
            <li><strong> To manage user accounts </strong> . We may use your information for the purposes of managing our account and keeping it in working order. <br />                          </li>
          ...
          <ul>
            ...
            <li><strong> Legitimate Interests: </strong> We may process your data when it is reasonably necessary to achieve our legitimate business interests.  <br /> </li>
          ...
          <ul>
            <li><strong> Cloud Computing Services </strong>   <br /> Google Cloud Platform</li>
          </ul>

                  
          <ul>
            <li><strong> Functionality and Infrastructure Optimization </strong>   <br /> Cloud Firestore and Firebase Realtime Database</li>
          </ul>
          ...
          <ul>
            <li><strong> Social Media Sharing and Advertising </strong>   <br /> Facebook advertising and Instagram advertising</li>
          </ul>
          
          <ul>
            <li><strong> User Account Registration and Authentication </strong>   <br /> Facebook Login and Google Sign-In</li>
          </ul>
            
          <ul>
            <li><strong> Web and Mobile Analytics </strong>   <br /> Google Analytics and Google Tag Manager</li>
          </ul>
          
          <ul>
            <li><strong> Website Hosting </strong>   <br /> Netlify</li>
          </ul>
          ...
          <p>If you have questions or comments about your privacy rights, you may email us at info@iconari.com.</p>
          ...
          <div>Iconari LLC</div>
          <div>1280 WILDWOOD LAKES BLVD APT 104</div>
